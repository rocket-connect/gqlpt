...
const AnnouncementBanner = () => (
  <div className="w-full bg-graphiql-dark text-graphiql-light text-center py-4 mt-2">
    <p className="text-lg font-bold">
      Interested in production ready text to GraphQL? Visit{" "}
      <a
        href="https://www.apipt.dev"
        target="_blank"
