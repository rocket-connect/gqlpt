...
const config: Config = {
  ...
  themeConfig: {
    metadata: [
      { name: "description", content: "AI Text To GraphQL." },
      {
        name: "keywords",
        content:
          "graphql, query, translation, ai, artifical, intelligence, openai, translate, autogenerated, chatgpt, text",
      },
      { name: "robots", content: "index, follow" },
      { name: "author", content: "GQLPT" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:site", content: "https://gqlpt.dev/" },
      { name: "twitter:title", content: "GQLPT" },
      { name: "twitter:description", content: "AI Text To GraphQL." },
      { name: "twitter:image", content: "https://gqlpt.dev/banner.png" },
      { property: "og:type", content: "article" },
      { property: "og:title", content: "GQLPT" },
      { property: "og:description", content: "AI Text To GraphQL." },
      { property: "og:url", content: "https://gqlpt.dev/" },
      { property: "og:image", content: "https://gqlpt.dev/banner.png" },
    ],
